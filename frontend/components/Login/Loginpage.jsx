...
const Loginpage = () => {
  ...
  return (
    <div className="grid grid-cols-2 gap-8 pl-20 mx-20">
      <div className="w-10/12">
        ...
        <div className="mt-8">
          ...
          <div className="mt-8 flex justify-between items-center">
            ...
            <button className="font-medium text-base text--[#f06d63]">
              Forgot password
            </button>
          </div>
          <div className="mt-8 flex flex-col gap-y-4">
            <button
              className="transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-[#f06d63] rounded-xl text-white font-bold text-lg"
              type="button"
          ...
          <div className="mt-8 flex justify-center items-center">
            ...
            <a
              href="/signup"
              className="ml-2 font-medium text-base text-[#f06d63]"
            >
              Sign up
            </a>
          </div>
